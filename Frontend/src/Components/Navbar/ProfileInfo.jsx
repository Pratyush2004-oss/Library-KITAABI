...
const ProfileInfo = () => {
  ...
  return (
    <div className="flex-none mx-5 px-5 gap-5">
      ...
      <div className=" flex-col items-center dropdown dropdown-hover dropdown-end flex-1">
        ...
        <div>
          <h1 className='text-lg font-bold'>{(authUser.LoginType === "Reader") ? authUser.fullname : authUser.LibraryName}</h1>
        </div>
